...
public class PrefUtils {
     ...
     *  cordovaWebView  参数
     * @param context  上下文
     * @param detail_flag 调用js页面的标识
     * @param id  id
     * @param back_flag  返回标识
     * @return
     */
    public static boolean putCordova(Context context,  String detail_flag,String id,int back_flag) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putString("id", id);
        editor.putString("detail_flag", detail_flag);
        editor.putInt("back_flag", back_flag);
        return editor.commit();
    }
    /**
     ...
     * @param datalist
     */
    public static  <T>  void putList(Context context,String key, List<T> datalist) {
