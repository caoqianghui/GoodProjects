...
public class GoImageView extends ImageView {
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(GoImageView pinchImageView);
    }
    ...
    public GoImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(GoImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(GoImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(GoImageView.this);
            }
            return true;
        }
    });
